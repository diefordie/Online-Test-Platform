    ...
    <>
      ...
      <header className="bg-customBlue text-white p-4 sm:p-6 font-poppins" style={{ maxWidth: '1440px', height: '108px' }}>
        <div className="container mx-auto flex justify-start items-center p-0">
          <Link href="/">
            <img src="/image/menu.png" alt="Menu" className="h-7" style={{ maxWidth: '69px', height: '70px' }} />
          </Link>
          <Link href="/">
            <img src="/image/Vector.png" alt="Vector" className="h-6 ml-4" style={{ maxWidth: '279px', height: '50px' }} />
          </Link>
        </div>
      </header>
        ...
        <div className="container mx-auto flex justify-between items-center p-4">
          ...
          <nav className="flex w-full">
            <Link href="/Buat Soal" legacyBehavior>
              <a className="flex-1 items-center justify-center w-[200px] h-[56px] text-center font-bold font-poppins mb-7 
                hover:bg-white hover:text-black  rounded-lg transition-all duration-300">
                Buat Soal</a>
            </Link>
            ...
            <Link href="/Tes Terpublikasi"legacyBehavior>
              <a className="flex-1 items-center justify-center w-[200px] h-[56px] text-center font-bold font-poppins mb-7 
                hover:bg-white hover:text-black  rounded-lg transition-all duration-300">
                Tes Terpublikasi</a>
            </Link>
            <Link href="/Analisis"legacyBehavior>
              <a className="flex-1 items-center justify-center w-[200px] h-[56px] text-center font-bold font-poppins mb-7 
                hover:bg-white hover:text-black  rounded-lg transition-all duration-300">
                Analisis</a>
            </Link>
      ...
      {isDropdownOpen && (
        ...
        >
          <Link href="/profile-edit" legacyBehavior>
            <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-deepBlue hover:text-white rounded-md border-abumuda">
              Rename
            </a>
          </Link>
          <Link href="/logout" legacyBehavior>
            <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-deepBlue hover:text-white rounded-md">
              Delete page
            </a>
          </Link>
        </div>
        ...
        <div className="bg-[#FFFFFF] p-4 rounded-lg shadow-md w-full mb-6 " style={{height:''} }>
                ...
                <div className="border border-black bg-[#D9D9D9] p-2 rounded mb-4" style={{ maxWidth: '1309px', height: '250px' }}>
                  ...
                  <div className="p-4 flex justify-between items-center mb-0.5 w-full">
                    ...
                    <Link href="/Bobot" legacyBehavior>
                        <a className="hover:text-orange font-poppins mb-0 ">Bobot</a>
                    </Link>
                      <input
                        type="number"
                        value={q.weight}
                        onChange={(e) => handleQuestionChange(questionIndex, 'weight', Number(e.target.value))}
                        className="w-full sm:w-16 p-2 border border-black rounded ml-2 align-middle"
                        placeholder="10"
                      />
                    </div>
                  </div>
              ...
              <div className="mb-4 space-y-4">
                {q.answers.map((answer, answerIndex) => (
                  <div key={answerIndex} className="flex space-x-4 items-center">
                    ...
                    <button onClick={() => handleAnswerRemove(questionIndex, answerIndex)} className="border-0 bg-transparent p-0">
                      <img src="/image/cancel.png" alt="cancel" className="h-7" style={{ maxWidth: '130px', height: '20px' }} />
                    </button>
                  </div>
                ))}
                <div className="flex flex-col space-y-4 mt-4">
                  <div className="flex items-center justify-between mt-4">
                    ...
                    >
                      <img src="/image/Group 266.png" alt="Tambah" className="h-8" />
          ...
          <div className="flex justify-end mt-4 space-x-2 mr-4">
            ...
            <div className="flex justify-start items-center">
              <button onClick={handleAddPage} className="bg-[#CFE9E6] border border-black text-black p-2 rounded-[15px] ml-4">
                Tambah Soal
              </button>
            </div>
            <div className="flex justify-start items-center">
              <button 
                onClick={handleLabel} 
                className="bg-blue-500 text-white border border-black px-4 py-2 rounded-[15px]"
              >
                Tambah Page
              </button> 
            </div>
            <div className="flex justify-end mt-4 space-x-2 mr-4">
              <Link href="/selesai" legacyBehavior>
                <a className='bg-[#E8F4FF] border border-black flex items-center space-x-2 px-4 py-2 hover:text-white font-poppins rounded-[15px]'> 
                  Selesai</a>
              </Link>
            </div>
