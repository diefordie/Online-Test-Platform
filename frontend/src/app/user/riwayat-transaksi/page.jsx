      ...
      <header className="w-[375px] h-[48px] sm:w-[1440px] sm:h-[115px] bg-[#0B61AA] text-white p-4 py-2 sm:py-8 relative z-50">
        <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="hidden sm:flex flex-wrap justify-center sm:justify-end items-center space-x-4">
            <Link href="/user/dashboard" className="hover:text-gray-200 text-2xl">
              Home
            </Link>
            <Link href="/user/favorite" className="hover:text-gray-200 text-2xl">
              Favorit
            </Link>
            <Link href="/user/riwayat-transaksi" className="text-black font-bold text-2xl">
              Transaksi
            </Link>
