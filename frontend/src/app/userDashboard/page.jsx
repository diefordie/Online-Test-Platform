    ...
    <>
      <header className="bg-deepBlue text-white p-6">
        <div className="container mx-auto flex justify-between items-center">
          <div className="">
            <Link href="/">
              <img src="/images/etamtest.png" alt="EtamTest" className="h-10" />
            </Link>
          </div>
      ...
      <section className="bg-gradient-custom p-20">
        <div className="container mx-auto mt-4">
          <form
            ...
            className="flex mx-auto items-center p-1 rounded-2xl bg-white max-w-[610px] font-poppins"
          >
            <input
              type="text"
            ...
            >
              <img src="/images/search-bar.png" alt="Search Icon" className="h-6 w-6" />
            </button>
          </form>
        </div>
      </section>
                  ...
                  <div className="flex justify-between space-x-2 leading-relaxed mt-1">
                    <div className="flex text-left leading-relaxed space-x-4">
                      <img
                        ...
                        className="h-5 w-5 leading-relaxed"
                      />
      ...
      <section className="p-5 text-deepBlue">
        <div className="container mx-auto mt-5 font-bold font-poppins text-deepBlue">Kategori</div>
          ...
          <div className="container grid grid-cols-4 sm:grid-cols-1 lg:grid-cols-4 gap-2 mt-3">
            <Link href="/pemrograman" legacyBehavior>
              <a className="hover:text-gray-300">
                <img src="/images/pemrograman.png" alt="pemrograman" className="h-250" />
              </a>
            </Link>
            <Link href="/cpns" legacyBehavior>
              <a className="hover:text-gray-300">
                <img src="/images/cpns.png" alt="pemrograman" className="h-250" />
              </a>
            </Link>
            <Link href="/psikotes" legacyBehavior>
              <a className="hover:text-gray-300">
                <img src="/images/psikotes.png" alt="psikotes" className="h-250" />
              </a>
            </Link>
            <Link href="/utbk" legacyBehavior>
              <a className="hover:text-gray-300">
                <img src="/images/utbk.png" alt="pemrograman" className="h-250" />
              </a>
            </Link>
          </div>
        </div>
      ...
      {popularTests.length > 0 && (
        <section className="bg-putih p-5 text-bold">
          <div className="container mx-auto mt-5 font-bold font-poppins text-deepBlue">Paling Populer</div>
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-4 mt-8">
      ...
      {freeTests.length > 0 && (
        <section className="bg-putih p-5 text-bold">
          <div className="container mx-auto mt-5 font-bold font-poppins text-deepBlue">Gratis</div>
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-4 mt-8">
            {freeTests.map((test) => (
              <div key={test.testId} className="bg-abumuda shadow-lg p-1 relative group">
                <div className="absolute inset-0 bg-gray-500 opacity-0 group-hover:opacity-40 transition-opacity duration-300 z-10"></div>
