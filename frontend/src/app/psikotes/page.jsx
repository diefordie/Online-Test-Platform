...
const testData = [
  {
    ...
    judul : "TRY OUT PSIKOTEST 2025#1",
...
export default function psikotes() {
  ...
  return (
    <>
      ...
      {/* Judul besar */}
      <h5 className="text-3xl font-bold font-bodoni ">Latihan Soal Tes Psikotes</h5>
            ...
            <ol className="list-reset flex space-x-2 ">
              ...
              <li>
                <Link href="/CPNS" legacyBehavior>
                  <a className="hover:text-orange font-bodoni font-bold ">Latihan Tes Psikotes</a>
                </Link>
              </li>
            </ol>
          </nav>
    ...
    {/* Bagian Paling Populer */}
      ...
      {testData
        .filter((test) => test.kategori === "Try Out Psikotes")
        .map((test) => (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-4 mt-8">
      {testData
        .filter((test) => test.kategori === "Try Out Psikotes") // Filter hanya data dengan kategori "Tru Out Psikotest"
